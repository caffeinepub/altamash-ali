...
const steps = [
  {
    icon: "📱",
    title: "Open UPI App",
    desc: "Open any UPI app like PhonePe, GPay, Paytm, FamPay, or your bank app",
  },
  {
    icon: "📷",
    title: "Scan QR Code",
    desc: "Scan the QR code shown below, or manually enter the UPI ID",
  },
  {
    icon: "💰",
    title: "Enter Amount",
    desc: "Enter the exact amount as shown in your order",
  },
  {
    icon: "📸",
    title: "Send Screenshot",
    desc: "After payment, send the screenshot on WhatsApp to confirm your order",
  },
];
...
const upiApps = [
  ...
  {
    name: "FamPay",
    logo: "/assets/generated/fampay-logo.dim_128x128.png",
    highlight: true,
  },
  { name: "BHIM" },
  { name: "Amazon Pay" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Scan the QR code or use the UPI ID to make payment. After payment,
          ...
          <div className="bg-card gold-border rounded-2xl p-6 card-glow flex flex-col items-center">
            ...
            <div className="w-full bg-surface rounded-xl p-4">
              ...
              <div className="flex items-center justify-between gap-3">
                <code className="text-gold font-mono font-bold text-sm flex-1 break-all">
                  {UPI_ID}
                </code>
                <Button
                  onClick={handleCopy}
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4">
              {steps.map((step, i) => (
                <div
                  key={step.title}
                  className="flex gap-4 bg-card gold-border rounded-xl p-4 card-glow"
                >
              ...
              <div className="flex flex-wrap gap-2">
                {upiApps.map((app) =>
                  app.highlight ? (
                    <span
                      key={app.name}
                      className="inline-flex items-center gap-1.5 text-xs px-3 py-1 rounded-full bg-gold/10 border border-gold/40 text-gold font-semibold"
                    >
                      <img
                        src={app.logo}
                        alt="FamPay"
