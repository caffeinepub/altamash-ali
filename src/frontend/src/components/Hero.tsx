  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/4 left-4 md:left-12 hidden md:flex flex-col gap-3 animate-float">
        ...
        <div
          className="bg-card/80 backdrop-blur-sm gold-border rounded-xl p-3 flex items-center gap-2 card-glow"
      ...
      <div
        className="absolute top-1/3 right-4 md:right-12 hidden md:flex flex-col gap-3"
      ...
      >
        ...
        <div
          className="bg-card/80 backdrop-blur-sm gold-border rounded-xl p-3 flex items-center gap-2 card-glow animate-float"
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
          Get real Instagram Followers, Likes & YouTube Subscribers, Views,
          Likes at the best prices in India. Fast delivery, guaranteed results.
        </p>
