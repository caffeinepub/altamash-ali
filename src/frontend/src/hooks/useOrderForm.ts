...
import { getAllPackagesForService, pricingData } from "../data/pricingData";
...
export function useOrderForm() {
  ...
  const availablePackages = serviceId
    ? getAllPackagesForService(serviceId)
    : [];
  ...
  const isValid =
    serviceId !== "" && packageLabel !== "" && profileUrl.trim() !== "";
